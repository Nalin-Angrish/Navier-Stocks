...
// hours, or if the Asia/Kolkata timezone cannot be loaded.
...
// buffer window on a weekday.  The Risk Manager blocks new intents during
// this period to avoid the volatile market-open gap.
...
// IsClosingCutoff returns true if now is at or past 3:00 PM IST on a
// weekday.  The Risk Manager rejects new entries after this time and
// triggers the auto-square-off routine at 3:15 PM.
